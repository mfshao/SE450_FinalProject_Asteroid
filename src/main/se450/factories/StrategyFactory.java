...
/**
 * A factory for creating border strategies.
 */
public class StrategyFactory {
	...
	/**
	 * Make a new border strategy.
	 *
	 * @param sStrategy
	 *            The type of the strategy.
	 * @param dimension
	 *            The dimension of current screen area.
	 * @return The newly created boarder strategy.
	 * @throws BadStrategyException
	 *             the bad strategy exception
	 */
	public static IStrategy makeStrategy(final String sStrategy, final Dimension dimension)
			throws BadStrategyException {
